...
- [x] Validate tests and OpenSpec; synchronize the requirements and archive only after verification.
- [x] Deploy a patch atop the verified current image, preserving its existing changes; run installed synthetic controls and health checks.
