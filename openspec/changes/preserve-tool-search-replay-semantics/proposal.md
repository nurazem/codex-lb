...
while duplicate or non-terminal triggers are rejected before upstream work.
...
- Keep compact-trigger forwarding compatible for a single terminal trigger and
  fail closed for duplicate or non-terminal triggers.
